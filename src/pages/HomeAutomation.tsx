...
const HomeAutomation = () => {
  const content = verticals.automation;
  return (
    <VerticalPageLayout
      vertical={content}
    ...
    >
      <div className="space-grid two-column">
        <SpaceFrame>
          ...
          <h2>Automation built for everyday living</h2>
      ...
      <SpaceFrame>
        ...
        <h2>Automation packages at a glance</h2>
      ...
      <SpaceFrame>
        ...
        <h2>Automation-specific delivery</h2>
        <div className="card-grid">
      ...
      <SpaceFrame>
        ...
        <h2>Questions about automation?</h2>
        <div className="card-grid">
      ...
      <SpaceFrame>
        ...
        <h2>Need commercial automation?</h2>
      ...
      <SpaceFrame className="vertical-cta">
        <h2>Ready to simplify your routines?</h2>
        <p>Compare automation packages or explore add-ons tailored to your home.</p>
        <div className="space-section-actions">
